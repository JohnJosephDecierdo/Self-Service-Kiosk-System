    ...
    public partial class HomeForm : Form
    {
        ...
        private void OpenRoleWindow(string role)
        {
            ...
            switch (loggedInUser.Role.ToLower())
            {
                ...
                case "manager":  roleForm = new ManagerForm(loggedInUser.Username); break;
                case "owner":    roleForm = new OwnerForm(loggedInUser.Username);   break;
                default:
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            if (e.CloseReason == CloseReason.UserClosing)
            {
                var confirm = MessageBox.Show(
                    "Are you sure you want to exit the kiosk system?\n\nAll open windows will be closed.",
                    "Exit System", MessageBoxButtons.YesNo, MessageBoxIcon.Question,
                    MessageBoxDefaultButton.Button2); // No = default
